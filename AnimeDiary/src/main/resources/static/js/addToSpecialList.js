function addToSpecialList(status, animeId) {

    const csrfToken = $("#csrfToken").val();

    $(".dropdown-item-special-list").click(function () {
        $(".dropdown-item-special-list").removeClass("active-custom");
    ...
    $.ajax({
        ...
        url: "/add-to-list",
        data: {
            "anime_special_list_name": status,
            "anime_id": animeId
        },
